...
export function AuthBackdrop() {
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0">
      <div className="bg-surface-muted absolute -top-32 -left-32 size-130 rounded-full opacity-70 blur-3xl" />

      {/* Qiya karta faqat keng ekranda — tor ekranda forma bilan ustma-ust tushadi */}
      <div className="from-line to-surface-shell absolute top-[20%] -right-44 hidden h-135 w-85 rotate-12 overflow-hidden rounded-[72px] bg-linear-to-br xl:block">
      ...
      <div className="bg-surface-muted absolute -right-16 -bottom-16 size-95 rounded-[64px] opacity-80 blur-2xl" />
    </div>
  );
}
