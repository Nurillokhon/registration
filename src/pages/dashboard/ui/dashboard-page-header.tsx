  ...
  return (
    <header className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
      <div className="min-w-0">
        ...
        <h1 className="text-heading text-[26px] leading-tight font-extrabold tracking-tight wrap-break-word sm:text-[32px]">
          {title}
        </h1>
        {subtitle && (
          <p className="text-body mt-1.5 text-[14px] font-bold sm:text-[15px]">
            {subtitle}
          </p>
        )}
      </div>
