...
import { Button, buttonVariants, FileField, FormAlert, SelectField, TextField } from '@/shared/ui'
...
export function CertificateForm({
  ...
  const extraFields = parseFormSchemaFields(findSchemaForType(schemas, selectedType)?.schema)

  const updateField = <K extends CertificateFieldName>(field: K, value: CertificateFormValues[K]) => {
